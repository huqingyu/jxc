...
Dim Bmp 
Set Bmp = New SEIRSOFT_RndCodeBmp 
Bmp.SetTextInfo "seirsoft.com" 
...
Bmp.SessionName = "GetCode"
Bmp.TextLength = 4
Bmp.BackColor = "#EEEEEE,#AAFFFF"
Bmp.TextColor = "#FF0000,#FF3300,#AA3300" '文字颜色,多个颜色用"," 分 
Bmp.YawpColor = Bmp.TextColor 'noise color 
Bmp.YawpCount = 6    'noise
Bmp.Write() 
%>