...
var DvWnd={
	...
	open:function(){
		...
		s+='<span style="float:right"><a href="javascript:'+DvWnd.d.w+'.close();" class="dvwndclose"><img src="images/del.gif" border="0" ></a></span>'+DvWnd.title;
		s+='</div>';
		s+='<div id="'+DvWnd.d.c+'" class="dvwndchild">';
		s+=1==DvWnd.type?('<iframe id="'+DvWnd.d.e+'" name="'+DvWnd.d.e+'" src="about:blank"  scrolling="auto" style="width:100%;height:'+(DvWnd.height-30)+'px;" frameborder="0" hspace="0"></iframe>'):('<span style="padding:10px;">'+DvWnd.para+'</span>');
		s+='</div>';
		o.innerHTML=s;
