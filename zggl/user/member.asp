...
<table width="690" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>&nbsp;
      <textarea name="tjurl" id="tjurl" cols="50" rows="2" class="teinput">再续神州公测4区50倍经验 即将开放了,新功能新玩法,带给你不一样的体验,有兄弟来一起玩吗？ 赶快来注册帐号 http://passport.shenzhou2.com/register.asp?ID=<%=rs("ID")%></textarea>
...
<table width="690" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<b><font size="4" color="#FF0000">
                 请联系客服QQ：10154514 索取卡号</font></b><br>
　</td>
  </tr>
  <tr>
    <td>　</td>
