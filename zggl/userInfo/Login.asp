              ...
              <TR>
                <TD width="588" vAlign=top><BR>                    <BR>
                    <TABLE cellSpacing=0 cellPadding=0 width=572 border=0>
                      <TBODY>
                        <TR>
                          <TD><IMG height=11 src="images/hotel_dire_bar1.jpg" 
            width=572></TD>
                        </TR>
                      </TBODY>
                    </TABLE>
        ...
        <TR>
          ...
          <TD width=254 align="center"><table width="90%" border="0" cellspacing="0" cellpadding="2" align="center">
            ...
            <form name="userlogin" method="post" action="user_checklogin.asp">
              <tr>
                <td align="center"><font color="#999999">游客您好,预定房间请先登录</font></td>
              </tr>
              <tr>
                <td align="center">用户名：
              ...
              <tr>
                <td align="center" height="38">
                  ...
                  <input  onclick="window.location='getpwd.asp'" type=button value="忘 密" name=Submit3>
                </td>
              </tr>
            </form>
            <%else%>
...
response.write "<br><a href=OrderHotel.asp ><img src=""images/hotel_dire_btn1.jpg"" width=""90"" height=""29"" border=0></a>"
end if
%>                </td>
            </tr>
          </table>            <BR>                        </TD>
          <TD vAlign=middle width=316>
            <P align="center" style="MARGIN-TOP: 5px; LINE-HEIGHT: 200%"> 
              ...
              <a href="../hotel.html"><font color="#ff0000">返回酒店预定首页</font></a>              <BR>
          </P></TD>
          <TD width=1 bgColor=#88b3be><IMG height=1 
            src="images/z.gif" width=1></TD>
        </TR>
                    ...
                    <TABLE cellSpacing=0 cellPadding=0 width=572 border=0>
                      <TBODY>
                        <TR>
                          <TD><IMG height=11 src="images/hotel_dire_bar2.jpg" 
            width=572></TD>
                        </TR>
                      </TBODY>
                  </TABLE></TD>
