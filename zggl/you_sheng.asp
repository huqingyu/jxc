...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" valign="top"><TABLE WIDTH=98% BORDER=0 CELLPADDING=0 CELLSPACING=0>
        <tr>
          <TD height="30" style="border:1px solid #8CC363; background-color:#E7F5DD;padding:0 10px"><b>您现在的位置:</b><a href="index.asp">首页</a> &gt;&gt; 省内游</td>
        </tr>
      </TABLE>
        ...
        <tr>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" background="Images/pic16.gif" style="border:1px solid #CCCCCC;">
            <tr>
              ...
              <td width="82" style="font-size:14px; font-weight:bold;"><span class="STYLE7">省内游</span></td>
              <td width="379">&nbsp;</td>
            </tr>
          </table>
            <table width="100%" border="0" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF">
                  <% set rs= Server.CreateObject("adodb.recordset")
sql="select * from xianlu where x_leiid=12 order by id desc"
rs.open sql,conn,1 
while not rs.eof 
%>
