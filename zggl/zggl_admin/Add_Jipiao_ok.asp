...
set rs=nothing
session("content")=""
response.write "<script>alert('添加成功！');window.location.href='editnews.asp';</script>"
response.End
end if
%>
<!DOCTYPE HTML>
...
<body>
<br /><table border=1 align="center" cellPadding=0 cellSpacing=0 bordercolor="#999999" borderColorDark=#FFF bgcolor="#F9F9F9">
  <tr> 
    <td height="30" background="Images/topBar_bg.gif"> 
    <div align="center"><font color="red"><b>添加网站新闻</b></font></div>    </td>
  </tr>
  <tr> 
    <td height="168" valign="top" bgcolor="#FFF"> 
      <form name="form1" method="post" action="addnews.asp?action=save" onSubmit="return checkdata()" onReset="return ResetForm();">
        ...
        <table width="786" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="82" height="30" style="PADDING-LEFT: 6px">新闻主题：</td>
            <td width="704" style="PADDING-LEFT: 6px"> 
              <input name="Title" class="wenbenkuang" type="text" id="Title" style=" width:250;">
            </td>
          </tr>
          <tr> 
            <td width="82" height="30" style="PADDING-LEFT: 6px">发 表 人：</td>
            <td width="704" style="PADDING-LEFT: 6px"> 
              <input name="Admin" class="wenbenkuang" type="text" id="Admin">
            </td>
          </tr>
          <tr> 
            <td width="82" height="58" rowspan="3" style="PADDING-LEFT: 6px">新闻内容：</td>
            <td style="PADDING-LEFT: 6px" width="704" height="30">
