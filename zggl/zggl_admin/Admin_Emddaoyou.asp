...
<table width="95%" border=1 align="center" cellPadding=0 cellSpacing=0  bgcolor="#F9F9F9">
  ...
  <tr> 
	...
	rs.open "select * from daoyou",conn,1,1
				...
				response.write "数据库中无数据！"
  				...
  				if rs.eof And rs.bof then
      				...
      				if (currentpage-1)*MaxPerPage>totalput then
       				...
       				if currentPage=1 then
            			showContent
            			showpage totalput,MaxPerPage,"Admin_Emddaoyou.asp"
       				else
          				if (currentPage-1)*MaxPerPage<totalPut then
      ...
      <table width="98%" border=1 align="center" cellPadding=0 cellSpacing=0  bgcolor="#F9F9F9">
          ...
          <tr> 
            ...
            <td> 
              <div align="center"><a href="admin_daoyoueditdel.asp?id=<%=rs("id")%>&action=edit" title="编辑这个导游">编辑</a></div>
            </td>
            <td><div align="center"><a href="admin_daoyoueditdel.asp?id=<%=rs("id")%>&action=del" title="删除这个导游">删除</a></div></td>
          </tr>
          <%i=i+1
      ...
      <%  
				...
				End If  
					...
					Response.Write "<font class='contents'> 共有"&totalnumber&"条导游信息 " 
