...
mb_hotel_show=Request.Form("mb_hotel_show")
aa="http://"&Request.ServerVariables("server_name")&Request.ServerVariables("path_info")
aa= mid(aa,1,len(aa)-18)
content=replace(mb_hotel_show,aa,"")
session("mb_hotel_show")=mb_hotel_show
set rs=server.CreateObject("adodb.recordset")
rs.open ("select mb_hotel_show from mb"),conn,1,3
rs("mb_hotel_show")=mb_hotel_show
rs.update
rs.close
set rs=nothing
session("content")=""
