...
Xl_Top = Xl_Top&"<td width=""17%"" height=25 background=images/topBar_bg.gif align=center>线路名称：</td><td colspan=3 align=center><strong><font color=#FF6633>"&rs("x_name")&"</font></strong>"
Xl_Top = Xl_Top&"</td></tr><tr><td height=25 background=images/topBar_bg.gif align=center>特惠价格：</td>"
Xl_Top = Xl_Top&"<td width=""21%"" align=center><strong><font color=#FF0000>"&rs("x_baojia")&"</font></strong></td>"
Xl_Top = Xl_Top&"<td width=""16%"" background=images/topBar_bg.gif align=center> 所需时日： </td>"
Xl_Top = Xl_Top&"<td width=""19%"" align=center>"&rs("x_shijian")&"</td></tr><tr><td height=25 background=images/topBar_bg.gif align=center> 线路类型：</td>"
