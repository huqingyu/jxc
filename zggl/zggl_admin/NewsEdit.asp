...
set rs=nothing
session("content")=""
response.write "<script>alert('更改成功！');window.location.href='"&request("linkaddress")&"';</script>"
response.End
end if
%>
<!DOCTYPE HTML>
        ...
        <table width="786" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td width="704" style="PADDING-LEFT: 6px"> 
              <input name="Title" class="wenbenkuang" type="text" id="Title" value=<%=trim(rs("title"))%> style=" width:250;">
            </td>
          </tr>
          <tr> 
            <td width="82" height="30" style="PADDING-LEFT: 6px">发 表 人：</td>
            <td width="704" style="PADDING-LEFT: 6px"> 
              <input name="Admin" class="wenbenkuang" type="text" id="Admin" value=<%=trim(rs("Admin"))%>>
            </td>
          </tr>
          <tr> 
...
查看HTML源代码
          ...
          <tr>
            <td style="PADDING-LEFT: 6px"><script language="javascript">
		    	document.write ('<iframe src="textbox2.asp?action=modify&id=<%=id%>" id="message" width="630" height="450"></iframe>')
