...
{message.focus();
  ...
  var arr = showModalDialog("system/table.htm", "", "dialogWidth:22em; dialogHeight:20em; status:0;help:0");
...
{ message.focus();
  ...
  var range =message.document.selection.createRange();
  var arr = showModalDialog("system/flash.asp", "", "dialogWidth:20em; dialogHeight:18em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("system/media.asp", "", "dialogWidth:19em; dialogHeight:12em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("system/rm.asp", "", "dialogWidth:19em; dialogHeight:12em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("pic.asp", "", "dialogWidth:19em; dialogHeight:13em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("system/fieldset.htm", "", "dialogWidth:16.5em; dialogHeight:13.5em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("system/iframe.asp", "", "dialogWidth:22em; dialogHeight:13.5em; status:0;help:0");
...
var range =message.document.selection.createRange();
  ...
  var arr = showModalDialog("system/hr.htm", "", "dialogWidth:20em; dialogHeight:13.5em; status:0;help:0");
