...
<table class="J_list" width="100%" border="0" cellpadding="0" cellspacing="1">
  <tr>
    <td height="30" colspan="6" align="center" background="images/admin_bg_1.gif"><b><font class="STYLE1">文章管理</font></b></td>
  </tr>
<%
lei=request("lei")
if lei="" then
...
if pagecount > 0 then
	...
	if pagecount > 7 then
		...
		Response.Write("<a href=""news_list.asp?page=1"">1</a>")
	end if
...
<%
	...
	if pagecount > 7 then
%>
<a href="news_list.asp?page=<%=pagecount%>"><%=pagecount%></a>
<%
	end if
end if
%>
