...
Sub Content()
	...
	function MakeCode(){
		var b = false;
		var str = "<!--#" + "include file = \"....../xWebEditor/Include/DeCode.asp\"-->\n\n\n<" + "%\n\n";
		str += "Response.Write xWebEditor_DeCode(sContent, \"";
	...
	<textarea rows=3 cols=65 style='width:100%'>&lt;!--#include file = &quot;....../xWebEditor/Include/DeCode.asp&quot;--&gt;</textarea>
