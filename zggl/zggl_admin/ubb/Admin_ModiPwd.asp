...
<tr><td>新用户名：<input type=text class=input size=20 name=newusr value="<%=inHTML(Session("xWebEditor_User"))%>">&nbsp;&nbsp;旧用户名：<span class=highlight1><%=outHTML(Session("xWebEditor_User"))%></span></td></tr>
