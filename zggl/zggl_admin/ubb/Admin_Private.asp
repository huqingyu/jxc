...
If Session("xWebEditor_User") = "" Then
...
Sub Header()
	...
	Response.Write "<meta http-equiv='Content-Type' content='text/html; charset=gb2312'>" & _
		...
		"<link rev=MADE href='mailto:huqingyu@gmail.com'>"
	
	' 输出标题
	Response.Write "<title>xWebEditor - seirsoft在线文本编辑器 - 后台管理</title>"
...
Sub Footer()
	...
	Response.Write "<table border=0 cellpadding=0 cellspacing=0 width=778 align=center height=23 class=footer1>" & _
		"<tr valign=bottom>" & _
			"<td>&nbsp;&nbsp;<a href='http://seirsoft.com'><IMG src='admin/c_webasp.gif' border=0></a></td>" & _
	...
	Response.Write "<table border=0 cellpadding=0 cellspacing=3 align=center class=footer2>" & _
		"<tr>" & _
			"<td align=center>Copyright  &copy;  2010-2013 <b>seirsoft<font color=#CC0000>.com</font></b>, All Rights Reserved .</td>" & _
		"</tr>" & _
		"<tr>" & _
			"<td align=center><a href='mailto:huqingyu@gmail.com'>huqingyu@gmail.com</a></td>" & _
		"</tr>" & _
		"</table>"
