...
Sub DBConnBegin()
	...
	' Access数据库
	oConn.Open "Provider=Microsoft.Jet.OLEDB.4.0; Data Source=" & Server.MapPath("data/xWebEditor.asa")
	' SQL Server 2000数据库
	'oConn.Open "Provider=SQLOLEDB.1;Server=localhost;UID=xWebEditor;PWD=123456;Database=xWebEditor"
