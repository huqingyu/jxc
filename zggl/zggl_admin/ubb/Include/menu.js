...
function getFormatMenuRow(menu, html, image){
	var s_Disabled = "";
	if (!xWebEditor.document.queryCommandEnabled(menu)){
		s_Disabled = "disabled";
	}
...
function showContextMenu(event){
	...
	oPopupMenu.show(lefter, topper, width, height, xWebEditor.document.body);
	return false;
...
function showToolMenu(menu){
	...
	case "file":		// 文件视图菜单
		...
		sMenu += getMenuRow("", "ShowDialog('dialog/about.htm','400','220')", "about.gif", "关于xWebEditor");
		height = 208;
		break;
	case "table":		// 表格菜单
